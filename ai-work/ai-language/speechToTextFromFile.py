...
outputFile = "transcribe.txt"
audioFileName = "audio/speech01.wav"
config.speech_recognition_language="en-US"
audioInput = speechsdk.AudioConfig(filename=audioFileName)
...
if result.reason == speechsdk.ResultReason.RecognizedSpeech:
    print("Success")
    with open(outputFile, "w", encoding="utf-8") as readfile:
        readfile.write(result.text)
else:
    print("Error")